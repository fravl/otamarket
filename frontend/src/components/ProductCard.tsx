...
const ProductCard = ({ product }: { product: Product }) => {
    ...
    return (
        <React.Fragment>
            <div className="col-10 mx-auto mx-lg-0 col-md-3 col-lg-3 my-3">
            <Link className="product-card-navlink" to={`/${product.id}`}>
                <div className="product-card">
                    <div>
                        ...
                        />
                        <span className={`product-card-badge badge ${queueSize === 0 ? 'bg-success' : 'bg-warning' }`}>{queueSize} in queue</span>
